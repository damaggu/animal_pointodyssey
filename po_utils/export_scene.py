...
scene_info['data'] = ['background'] + assets_keys
...
if bpy.app.version < (4, 0, 0):
    ...
    bpy.ops.wm.obj_export(filepath=os.path.join(obj_save_dir, f'scene.obj'), export_materials=False)
...
if args.export_character:
    ...
    for frame_nr in frames:
        ...
        if bpy.app.version < (4, 0, 0):
            ...
            bpy.ops.wm.obj_export(filepath=os.path.join(obj_save_dir, f'character_{frame_nr:04d}.obj'),
